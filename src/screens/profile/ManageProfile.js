...
const ManageProfile = () => {
    ...
    <Row>
        ...
        <div style={{fontWeight:"bold", fontSize:25, marginTop:20, fontFamily: 'Montserrat, sans-serif'}}>
                    Edit Profile
        </div>
        <div  style={{display:"flex", justifyContent:"center", alignItems:"center", flexDirection:"column", marginTop:-60}}>
            ...
            <Form>
                ...
                <Button type="submit" style={{backgroundColor:"#098193", fontFamily: 'Montserrat, sans-serif'}}>
                    Submit
                </Button>
            </Form>
