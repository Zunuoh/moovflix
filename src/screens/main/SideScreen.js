...
const browseList = [
  { id: "0", name: "Discover" },
  { id: "1", name: "Tv & Movies" },
  { id: "2", name: "Popular Clips" },
  { id: "3", name: "Watch Later" },
];

const categoryList = [
  { id: "0", name: "Kuwait TV" },
  { id: "1", name: "Free Shows" },
  { id: "2", name: "Arabic" },
  { id: "3", name: "Action" },
  { id: "4", name: "Comedy" },
  { id: "5", name: "Drama" },
  ...
  return (
    <div className="sideScreenContainer">
      <div className="siteTitle">
        <h1 style={{ color: "white", fontFamily: "Redressed, cursive" }}>
          Telly
        </h1>
      </div>
      ...
      <div>
        ...
        {browsers &&
          browsers.map((browser) => {
            return <div className="browserText">{browser.name}</div>;
          })}
      </div>
      ...
      <div>
        ...
        {categories &&
          categories.map((category) => {
            return <div className="browserText">{category.name}</div>;
          })}
      </div>
    </div>
  );
