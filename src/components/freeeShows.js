...
const FreeShows = ()=>{
     ...
     useEffect(()=>{
         setLoading(true)
         axios.get('https://api.themoviedb.org/3/discover/movie?api_key=09f64a19d8a1ead17fb1701f58cd805a&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=3')
